            ...
            <div className="h-full p-6">
              <div className="flex justify-between items-center mb-8">
                ...
                <div className="flex space-x-2">
                  <button
                    className="bg-white text-[#2E8B57] px-3 py-1 text-sm font-bold hover:bg-[#f0f9f4] hover:text-[#1a6b3c] transition-all duration-300 border border-[#2E8B57] rounded-md"
                  >
                    换一批
                  </button>
                  <a
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3">
                ...
                {Array.from({ length: 10 }).map((_, index) => (
                  <div key={`city-${index}`} className="hover-frame-effect bg-white p-1 rounded shadow">
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-lg shadow-lg w-full h-[calc(100%-9px)] overflow-y-auto">
            <div className="h-full p-6">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3">
                ...
                {Array.from({ length: 10 }).map((_, index) => (
                  <div key={`food-${index}`} className="hover-frame-effect bg-white p-1 rounded shadow">
                    <div className="relative aspect-square overflow-hidden">
                      <div className="absolute inset-0 bg-gray-200 animate-pulse"></div>
                      {/* Placeholder for actual images */}
                      <div className="absolute inset-0 flex items-center justify-center text-gray-400 text-xs">
            ...
            <div className="h-full p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <p className="text-gray-600 text-sm">我们已经收录了1,234个中国文化词条，涵盖衣食住行各个方面。</p>
                </div>

                <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                  <div className="flex items-center mb-4">
                    <div className="w-12 h-12 bg-[#C20F1E]/10 rounded-full flex items-center justify-center mr-4">
                      <svg className="w-6 h-6 text-[#C20F1E]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="text-gray-600 text-sm">来自全球各地的访问者，共同探索中国文化的魅力。</p>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <p className="text-gray-600 text-sm">来自不同领域的专家和爱好者，共同构建这个知识库。</p>
                </div>
              </div>

              <div className="mt-8 text-center">
                <a href="/progress" className="inline-flex items-center text-[#2E8B57] hover:text-[#1a6b3c] font-medium">
                  查看更多数据
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                  <div className="bg-[#2E8B57] text-white p-4">
                    <h3 className="text-xl font-bold font-serif-sc">线上活动</h3>
                  </div>
                  <div className="p-6">
                    <ul className="space-y-4">
                      <li className="flex items-start">
                        <div className="flex-shrink-0 w-10 h-10 bg-[#2E8B57]/10 rounded-full flex items-center justify-center mr-3">
                          <svg className="w-5 h-5 text-[#2E8B57]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                          </svg>
                        </div>
                        <div>
                          <h4 className="font-medium">中国文化线上讲座</h4>
                          <p className="text-sm text-gray-600">每周四晚8点，专家带你探索中国文化的方方面面。</p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <div className="flex-shrink-0 w-10 h-10 bg-[#2E8B57]/10 rounded-full flex items-center justify-center mr-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">分享你的知识，成为我们的内容贡献者。</p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <div className="flex-shrink-0 w-10 h-10 bg-[#2E8B57]/10 rounded-full flex items-center justify-center mr-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">加入我们的论坛，与志同道合的朋友交流。</p>
                        </div>
                      </li>
                    </ul>
                    <div className="mt-6 text-center">
                      <a href="/community" className="inline-block bg-[#2E8B57] text-white px-4 py-2 rounded-md hover:bg-[#236b42] transition-colors duration-300">
                        参与线上活动
                      </a>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                  <div className="bg-[#C20F1E] text-white p-4">
                    <h3 className="text-xl font-bold font-serif-sc">线下活动</h3>
                  </div>
                  <div className="p-6">
                    <ul className="space-y-4">
                      <li className="flex items-start">
                        <div className="flex-shrink-0 w-10 h-10 bg-[#C20F1E]/10 rounded-full flex items-center justify-center mr-3">
                          <svg className="w-5 h-5 text-[#C20F1E]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                          </svg>
                        </div>
                        <div>
                          <h4 className="font-medium">文化体验工作坊</h4>
                          <p className="text-sm text-gray-600">每月举办，亲身体验中国传统工艺的魅力。</p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <div className="flex-shrink-0 w-10 h-10 bg-[#C20F1E]/10 rounded-full flex items-center justify-center mr-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">跟随我们的导览，探索城市中的文化宝藏。</p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <div className="flex-shrink-0 w-10 h-10 bg-[#C20F1E]/10 rounded-full flex items-center justify-center mr-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">与社区成员面对面交流，分享经验。</p>
                        </div>
                      </li>
                    </ul>
                    <div className="mt-6 text-center">
                      <a href="/community" className="inline-block bg-[#C20F1E] text-white px-4 py-2 rounded-md hover:bg-[#A00D19] transition-colors duration-300">
                        参与线下活动
                      </a>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                  <div className="border-b border-gray-100 pb-4 mb-6">
                    ...
                    <p className="text-gray-600 text-sm mt-2">获取最新的中国文化与生活方式资讯，每周精选内容直达您的邮箱。</p>
                  </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                  <div className="border-b border-gray-100 pb-4 mb-6">
                    <h2 className="text-2xl font-bold font-serif-sc text-[#C20F1E]">关于我们</h2>
                    <p className="text-gray-600 text-sm mt-2">Chinawords致力于记录和分享当代中国的生活方式与文化创新。</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex space-x-4 mt-6">
                      <a href="/about" className="text-[#C20F1E] hover:underline inline-flex items-center text-sm">
                        了解更多
                        <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                      </a>
                      <a href="/careers" className="text-[#C20F1E] hover:underline inline-flex items-center text-sm">
                        加入我们
                        <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <ul className="space-y-2 text-xs text-gray-600">
                      <li><a href="/about#mission" className="hover:text-[#C20F1E]">我们的使命</a></li>
                      <li><a href="/about#team" className="hover:text-[#C20F1E]">团队介绍</a></li>
                      <li><a href="/about#partners" className="hover:text-[#C20F1E]">合作伙伴</a></li>
                      <li><a href="/careers" className="hover:text-[#C20F1E]">加入我们</a></li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="text-sm font-bold mb-3">基础板块</h3>
                    <ul className="space-y-2 text-xs text-gray-600">
                      <li><a href="/fashion" className="hover:text-[#C20F1E]">衣·时尚传承</a></li>
                      <li><a href="/food" className="hover:text-[#C20F1E]">食·味蕾中国</a></li>
                      <li><a href="/living" className="hover:text-[#C20F1E]">住·空间美学</a></li>
                      <li><a href="/travel" className="hover:text-[#C20F1E]">行·绿色出行</a></li>
                    </ul>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-xs text-gray-600">
                      <li><a href="/community" className="hover:text-[#C20F1E]">社区活动</a></li>
                      <li><a href="/upload" className="hover:text-[#C20F1E]">内容贡献</a></li>
                      <li><a href="/feedback" className="hover:text-[#C20F1E]">意见反馈</a></li>
                    </ul>
                  </div>
                </div>
