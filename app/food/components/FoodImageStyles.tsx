...
const FoodImageStyles: React.FC = () => {
  return (
    <style jsx global>{`
      ...
      /* Cuisine filter styles now handled by Tailwind classes */

      /* Utility classes converted to Tailwind:
       * .text-jade-green → text-jade-green 
       * .border-jade-green → border-jade-green
