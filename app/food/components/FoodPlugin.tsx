...
const FoodPlugin: React.FC = () => {
  return (
    <div className="plugin-container max-w-6xl mx-auto px-4 py-8 font-sans-sc">
      ...
      {/* 开源代码区域 */}
      <div className="opensource-section text-center">
        <h2 className="text-2xl font-bold mb-4 font-serif-sc text-gray-800">开源代码</h2>
        ...
        <a
          ...
          className="inline-flex items-center bg-gray-800 text-white px-6 py-3 rounded-md hover:bg-gray-700 transition-colors duration-300 shadow-md hover:shadow-lg"
        >
