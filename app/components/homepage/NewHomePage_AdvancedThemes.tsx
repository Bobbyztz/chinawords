...
const NewHomePage_AdvancedThemes: React.FC<NewHomePageAdvancedThemesProps> = ({ initiativesData, registerSection }) => {
  return (
    <section
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <a
                    ...
                    className="text-film-red hover:text-film-red/90 hover:underline inline-flex items-center text-sm font-medium"
                  >
                    了解更多
                    <svg
