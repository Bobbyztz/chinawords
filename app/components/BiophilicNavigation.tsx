    ...
    >
      <div className="container mx-auto px-4 md:px-6 flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center">
          ...
          <span className="text-lg font-medium text-nature-heading">Eco Biophilic Hub</span>
        </Link>
        ...
        <div className="hidden md:flex items-center space-x-1">
          ...
          <button className="btn-organic ml-4 text-sm">Join Our Mission</button>
        </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex flex-col space-y-3">
            ...
            <button className="btn-organic my-2 mx-4">Join Our Mission</button>
          </div>
        </div>
      </div>
    </nav>
