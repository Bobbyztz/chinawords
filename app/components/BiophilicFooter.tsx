              ...
              {socialLinks.map((link, index) => (
                ...
                >
                  ...
                  {link.iconType === 'xiaohongshu' && (
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M5.5 4h13A1.5 1.5 0 0 1 20 5.5v13a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 18.5v-13A1.5 1.5 0 0 1 5.5 4zm4.97 13.11c.26 0 .49-.13.63-.35l1.9-2.75 1.9 2.75c.14.21.37.35.63.35h1.02c.2 0 .39-.1.5-.26a.6.6 0 0 0 .08-.56l-2.73-3.95 2.34-3.42c.1-.17.12-.38.04-.57a.62.62 0 0 0-.5-.26h-1.02c-.26 0-.49.13-.63.35l-1.63 2.4-1.63-2.4a.73.73 0 0 0-.63-.35H9.72c-.2 0-.39.1-.5.26a.6.6 0 0 0-.08.56l2.34 3.42-2.73 3.95c-.1.17-.12.38-.04.57a.62.62 0 0 0 .5.26h1.02z"/>
                    </svg>
                  )}
